...
export default function AnnouncementList() {
  ...
  return (
    <CourseLayout isSuccess={isSuccess}>
      <AnnouncementView data={data?.pages?.flatMap((item) => item.data)} fetchMore={fetchNextPage} hasMore={hasNextPage} />
    </CourseLayout>
  );
}

function AnnouncementView(props: { data: Announcement[]; fetchMore: () => void; hasMore: boolean}) {
